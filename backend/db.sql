...
-- Product
CREATE SEQUENCE IF NOT EXISTS public.ID_SEQ_PRODUCT INCREMENT 1 START 1;
CREATE TABLE IF NOT EXISTS public.PRODUCT(
    ID INTEGER PRIMARY KEY NOT NULL
);
ALTER TABLE public.PRODUCT ADD COLUMN NAME CHARACTER VARYING NOT NULL;
ALTER TABLE public.PRODUCT ADD COLUMN REFERENCE CHARACTER VARYING NOT NULL;
ALTER TABLE public.PRODUCT ADD COLUMN BARCODE CHARACTER VARYING NOT NULL;
ALTER TABLE public.PRODUCT ADD COLUMN IS_ADMIN BOOLEAN;
